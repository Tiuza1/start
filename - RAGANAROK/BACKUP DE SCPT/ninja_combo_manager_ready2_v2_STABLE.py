...
# Tempo de execução de cada comando no Arduino (baseado em hold=14ms, after=14ms)
# FULL_COMBO: F1(28ms) + F2(28ms) + F3(28ms) + click(14ms) ≈ 105ms
# ATK:        F3(28ms) + click(14ms) ≈ 45ms
FULL_COMBO_EXEC  = 0.105   # segundos que o Arduino leva para executar FULL_COMBO
ATK_EXEC         = 0.045   # segundos que o Arduino leva para executar ATK

# Espera adicional após o comando (reação do jogo / ícone da aura atualizar)
POST_CMD_WAIT    = 0.115   # ajuste conforme necessário (total ciclo ~220ms)
